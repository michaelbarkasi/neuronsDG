...
Network topologies are held in a special class of objects, **network**, from the neurons package. A new network object can be created with the [new.network()](../reference/new.network.html) function. 
